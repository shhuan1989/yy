...
class ActorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Actor entity")
        ...
        .repeat(2) {
            ...
            .post("/api/actors")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "gender":"0", "birthDate":null, "height":null, "bust":null, "waist":null, "hip":null, "tel":"SAMPLE_TEXT", "inputOperator":"SAMPLE_TEXT", "inputTime":null, "lastModifier":"SAMPLE_TEXT", "lastModifiedTime":null, "age":"0"}""")).asJSON
            .check(status.is(201))
