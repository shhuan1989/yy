(function() {
    ...
    angular
        .module('yyOaApp')
        .controller('BudgetNewController', BudgetNewController);

    BudgetNewController.$inject = ['$scope', '$state', '$stateParams', 'disableEdit', 'ShootConfigService', 'ProjectManagementService', 'EquipmentManagementService', 'StaffManageService', 'ActorRepoService', 'EmployeeService'];

    function BudgetNewController ($scope, $state, $stateParams, disableEdit, ShootConfigService, ProjectManagementService, EquipmentManagementService, StaffManageService, ActorRepoService, EmployeeService) {
        var vm = this;
        ...
        function save() {
            ...
            var valid = $('.budget-new-content table').parsley().validate();
            if (!valid) {
                PNotifyInvalidInput();
                vm.isSaving = false;
                return;
