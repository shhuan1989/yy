(function() {
    ...
    angular
        .module('yiyingOaApp')
        .controller('PerformanceAprovalController', PerformanceAprovalController);

    PerformanceAprovalController.$inject = ['$scope', '$rootScope', '$state', '$stateParams', 'PerformanceApprovalRequest', 'ProjectManagementService', 'PerformanceApprovalService', 'UserService'];

    function PerformanceAprovalController ($scope, $rootScope, $state, $stateParams, PerformanceApprovalRequest, ProjectManagementService, PerformanceApprovalService, UserService) {
        var vm = this;
        ...
        */
        ...
        function load() {
            ...
            ProjectManagementService.get({id: vm.projectId},
                function (project) {
                    ...
                    vm.project.bonusApproval = project.bonusApprovals ==undefined ? {} : project.bonusApprovals.find(function (item) {
        ...
        vm.approve = function () {
            PerformanceApprovalService.approve(vm.approval.id)
                .then(function () {
        ...
        vm.reject = function () {
            bootboxConfirmReject(function (result) {
                PerformanceApprovalService.reject(vm.approval.id, result)
                    .then(function () {
