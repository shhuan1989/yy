...
import com.yijia.yy.service.dto.UserDTO;
import com.yijia.yy.service.mapper.UserMapper;
import com.yijia.yy.web.rest.vm.KeyAndPasswordVM;
    ...
    public ResponseEntity<UserDTO> getAccount() {
        return Optional.ofNullable(userService.getUserWithAuthorities())
            .map(user -> {
                ...
                Set<String> auths = userDTO.getAuthorities() != null ? userDTO.getAuthorities() : new HashSet<>();
                auths.addAll(userService.roles2Auths(userDTO.getRoles()));
